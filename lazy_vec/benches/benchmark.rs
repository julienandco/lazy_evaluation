...
fn lazy_vec_add_large() -> Vec3 {
    ...
    Vec3::from(a + b + c + d + e + f + g + h)
}

#[inline(never)]
fn normal_vec_add_large() -> BadVec3 {
    let a = BadVec3 { x: 1.4, y: 2.5, z: 40.2, };
    let b = BadVec3 { x: 34.7, y: 2.6, z: 20.9, };
...
#[inline(never)]
fn normal_vec_sub_large() -> BadVec3 {
    let a = BadVec3 { x: 1.4, y: 2.5, z: 40.2, };
    let b = BadVec3 { x: 34.7, y: 2.6, z: 20.9, };
    let c = BadVec3 { x: 78.6, y: 2.3, z: 495.0, };
    let d = BadVec3 { x: 23.4, y: 53.94, z: 75.1, };
...
#[inline(never)]
fn lazy_vec_scale() -> Vec3 {
    let a = Vec3::new(1.4, 2.5, 40.2);
    Vec3::from(3.2 * a)
}

#[inline(never)]
fn normal_vec_scale() -> BadVec3 {
    let a = BadVec3 { x: 1.4, y: 2.5, z: 40.2, };
    3.2 * a
}

#[inline(never)]
fn lazy_vec_mul() -> Vec3 {
    let a = Vec3::new(1.4, 2.5, 40.2);
    let b = Vec3::new(34.7, 2.6, 20.9);
    Vec3::from(a * b)
}
...
#[inline(never)]
fn normal_vec_mul_large() -> BadVec3 {
    let a = BadVec3 { x: 1.4, y: 2.5, z: 40.2, };
    let b = BadVec3 { x: 34.7, y: 2.6, z: 20.9, };
    let c = BadVec3 { x: 78.6, y: 2.3, z: 495.0, };
    let d = BadVec3 { x: 23.4, y: 53.94, z: 75.1, };
